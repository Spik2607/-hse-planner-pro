...
export default function EnvironnementPage() {
  ...
  const handleAddItem = () => {
    if (newItem.trim()) {
      setNewChecklist({ ...newChecklist, items: [...newChecklist.items, { question: newItem, answer: null }] });
      setNewItem("");
    }
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader><CardTitle>➕ Créer Nouvelle Checklist</CardTitle></CardHeader>
        <CardContent className="space-y-4">
          ...
          <Button className="w-full" onClick={handleAddChecklist}>Créer Checklist</Button>
        </CardContent>
      </Card>

      {/* Affichage Checklists */}

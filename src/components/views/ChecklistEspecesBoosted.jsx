...
export default function ChecklistEspecesBoosted() {
  const [controls, setControls] = useState([
    { question: "Observation d'espèces protégées ?", answer: null },
    { question: "Mesures de protection mises en place ?", answer: null },
    { question: "Signalisation adaptée visible ?", answer: null }
  ]);
  ...
  return (
    <Card>
      <CardHeader><CardTitle>Check-list Espèces Protégées (Boostée)</CardTitle></CardHeader>

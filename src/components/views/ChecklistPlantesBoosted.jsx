...
export default function ChecklistPlantesBoosted() {
  const [controls, setControls] = useState([
    { question: "Présence de plantes invasives détectée ?", answer: null },
    { question: "Traitement ou arrachage effectué ?", answer: null },
    { question: "Surface contaminée importante ?", answer: null }
  ]);
  ...
  return (
    <Card>
      <CardHeader><CardTitle>Check-list Plantes Invasives (Boostée)</CardTitle></CardHeader>

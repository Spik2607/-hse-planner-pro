...
export default function ChecklistPoussieresBoosted() {
  const [controls, setControls] = useState([
    { question: "Présence de poussières visibles dans l'air ?", answer: null },
    { question: "Routes ou chemins boueux ?", answer: null },
    { question: "Systèmes anti-poussières fonctionnels ?", answer: null }
  ]);
  ...
  return (
    <Card>
      <CardHeader><CardTitle>Check-list Poussières (Boostée)</CardTitle></CardHeader>
